            ...
            <div class="col-md-7 col-lg-5">
                <div class="login-wrap p-4 p-md-5">
                    ...
                    <form:form method="post" action="${action}" modelAttribute="user" class="login-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group d-flex">
                            <form:input type="text" class="form-control rounded-left" placeholder="Name" id="name" name="name" path="name" required="true"/>
                        </div>
                        <br>
                        <div class="form-group d-flex">
                            <form:input type="email" class="form-control rounded-left" placeholder="Email" id="email" name="email" path="email" required="true"/>
                        </div>
                        <br>
                        <div class="form-group">
                            <form:input type="text" class="form-control rounded-left" placeholder="Username" id="userName" name="userName" path="userName" required="true"/>
                        </div>
                        <br>
